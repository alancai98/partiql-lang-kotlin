...
class SqlParser(private val ion: IonSystem) : Parser {
    ...
    private fun List<Token>.parseUnaryTermRepeat(): ParseNode =
        when (head?.isUnaryOperator) {
            true -> {
                val op = head!!
    ...
    private fun List<Token>.parseUnaryTermRepeat2(): ParseNode =
        when (head?.isUnaryOperator) {
            true -> {
                val op = head!!
    ...
    private fun List<Token>.parseUnaryTermRepeat3(): ParseNode =
        when (head?.isUnaryOperator) {
            true -> {
                val op = head!!
